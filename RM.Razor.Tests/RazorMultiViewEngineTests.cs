namespace RM.Razor.Tests {
    ...
    public class RazorMultiViewEngineTests {
        ...
        private RazorMultiViewEngine CreateSuccessfulViewEngine() {
        ...
        private static IHostEnvironment GetTestEnvironment() {
            var mock = new Mock<IHostEnvironment>();
            mock.Setup(e => e.ContentRootPath).Returns("./");
           return mock.Object;
        
        }

        private static IOptions<RazorMultiViewEngineOptions> GetOptionsAccessor(
            IEnumerable<IViewLocationExpander> expanders = null,
            ...
            var optionsAccessor = new Mock<IOptions<RazorMultiViewEngineOptions>>();
            optionsAccessor
                .SetupGet(v => v.Value)
                .Returns(options);
        ...
        private class TestableRazorViewEngine : RazorMultiViewEngine {
            public TestableRazorViewEngine(
                IRazorPageFactoryProvider pageFactory,
                IOptions<RazorMultiViewEngineOptions> optionsAccessor)
                : base(Mock.Of<IHttpContextAccessor>(), pageFactory, Mock.Of<IRazorPageActivator>(), new HtmlTestEncoder(), optionsAccessor, new DiagnosticListener("Microsoft.AspNetCore.Mvc.Razor")) {
            }
