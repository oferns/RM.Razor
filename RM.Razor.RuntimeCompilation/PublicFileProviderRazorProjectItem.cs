...
namespace RM.Razor.RuntimeCompilation {
    ...
    public class PublicFileProviderRazorProjectItem : RazorProjectItem {
        private string _root;
        private string _relativePhysicalPath;
        private bool _isRelativePhysicalPathSet;

        public PublicFileProviderRazorProjectItem(IFileInfo fileInfo, string basePath, string filePath, string root) : this(fileInfo, basePath, filePath, root, fileKind: null) {
        }

        public PublicFileProviderRazorProjectItem(IFileInfo fileInfo, string basePath, string filePath, string root, string fileKind) {
            FileInfo = fileInfo;
            BasePath = basePath;
            FilePath = filePath;
