...
namespace RM.Razor.RuntimeCompilation {
    ...
    public class PublicCSharpCompiler {
        private readonly PublicRazorReferenceManager _referenceManager;
            ...
            if (string.IsNullOrEmpty(dependencyContextOptions.DebugType)) {
                ...
                switch (dependencyContextOptions.DebugType.ToLower()) {
                    ...
                    case "pdbonly":
                        ...
                        break;
                    default:
                        throw new InvalidOperationException("Unsupported debug type");
                }
            }
