namespace RM.Razor.StaticFiles {
    ...
    public struct MultiTenantStaticFileContext {
        ...
        public MultiTenantStaticFileContext(HttpContext context, StaticFileOptions options, ILogger logger, IFileProvider fileProvider, string contentType, PathString subPath) {
            _context = context;
            _options = options;
