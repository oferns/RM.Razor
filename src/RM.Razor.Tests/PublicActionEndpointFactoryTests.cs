namespace RM.Razor.Tests {
    ...
    public class PublicActionEndpointFactoryTests {
        public class ActionEndpointFactoryTest {
            public ActionEndpointFactoryTest() {
                ...
                var routeOptionsSetup = Activator.CreateInstance(typeof(PublicMvcCoreRouteOptionsSetup), true) as PublicMvcCoreRouteOptionsSetup;
                ...
                Factory = new PublicActionEndpointFactory(Services.GetRequiredService<RoutePatternTransformer>());
            }

            internal PublicActionEndpointFactory Factory { get; }
            ...
            public void AddEndpoints_CreatesInertEndpoint() {
                ...
                // Act
                var endpoints = CreateConventionalRoutedEndpoints(action, Array.Empty<PublicConventionalRouteEntry>(), createInertEndpoints: true);
            ...
            private RouteEndpoint CreateAttributeRoutedEndpoint(ActionDescriptor action) {
                ...
                Factory.AddEndpoints(endpoints, new HashSet<string>(), action, Array.Empty<PublicConventionalRouteEntry>(), Array.Empty<Action<EndpointBuilder>>(), createInertEndpoints: false);
            ...
            private RouteEndpoint CreateConventionalRoutedEndpoint(ActionDescriptor action, string template) {
                return CreateConventionalRoutedEndpoint(action, new PublicConventionalRouteEntry(routeName: null, template, null, null, null, order: 0, new List<Action<EndpointBuilder>>()));
            }
            ...
            private IReadOnlyList<Endpoint> CreateConventionalRoutedEndpoints(ActionDescriptor action, IReadOnlyList<PublicConventionalRouteEntry> routes, bool createInertEndpoints = false) {
                var endpoints = new List<Endpoint>();
            ...
            private PublicConventionalRouteEntry CreateRoute(
                string routeName,
                string pattern,
                ...
                return new PublicConventionalRouteEntry(routeName, pattern, defaults, constraints, dataTokens, order, conventions);
            }
